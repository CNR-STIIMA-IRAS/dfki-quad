...
GaitReferenceTrajectoryPlanner::GaitReferenceTrajectoryPlanner(double dt,
...
void GaitReferenceTrajectoryPlanner::plan_trajectory(GaitSequence& sequence, const Target& target) {
...
void GaitReferenceTrajectoryPlanner::plan_desired_trajectory(GaitSequence& sequence, const Target& target) {
...
void GaitReferenceTrajectoryPlanner::set_sequence_mode(GaitSequence& sequence, const Target& target) {
...
void GaitReferenceTrajectoryPlanner::set_current_target(GaitSequence& sequence, const Target& target) {
  Eigen::Vector3d position = sequence.reference_trajectory_position[0];
  Eigen::Quaterniond orientation = sequence.reference_trajectory_orientation[0];
  Eigen::Vector3d velocity = sequence.reference_trajectory_velocity[0];
  Eigen::Vector3d twist = sequence.reference_trajectory_twist[0];

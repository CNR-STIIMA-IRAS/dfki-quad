...
class MPC : public MPCInterface {
 public:
  static constexpr double MPC_DT = MPC_DT_NS* 1e-9;
 ...
 public:
  ...
  void GetWrenchSequence(WrenchSequenceInterface* wrench_sequence,
...
// template<size_t N_LEGS, size_t PREDICTION_HORIZON, size_t MPC_DT_NS, size_t STATE_SIZE>
using MPCInterface_L4_H10_DT1000_S13 = MPC<4, 10, 1000, 13>;
using MPCInterface_L4_H15_DT1000_S13 = MPC<4, 15, 1000, 13>;

}

#include "quad_mpc/impl/quad_mpc.tpp"